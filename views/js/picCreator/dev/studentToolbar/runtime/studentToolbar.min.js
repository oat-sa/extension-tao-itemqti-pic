...
},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack;var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery}),jQuery.noConflict(!0)}),define("studentToolbar/runtime/studentToolbar",["taoQtiItem/portableLib/jquery_2_1_1","qtiInfoControlContext"],function($,qtiInfoControlContext){"use strict";var studentToolbar={id:-1,getTypeIdentifier:function(){return"studentToolbar"},initialize:function(id,dom,config){
this.id=id,this.dom=dom,this.config=config||{}},destroy:function(){var $container=$(this.dom);$container.off().empty()},setSerializedState:function(state){},getSerializedState:function(){return{}}};qtiInfoControlContext.register(studentToolbar)}),define(["studentToolbar/runtime/studentToolbar"],function(PIC){return PIC});
